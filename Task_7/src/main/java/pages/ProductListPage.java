...
public class ProductListPage extends AbstractPage {
    ...
    private static final By PRODUCT_NAME = By.xpath("//a[@title='DSC-H20 Blue']");
    ...
    private static final By ADD_TO_SHOPPING_CART_BUTTON = By.xpath("private static final By ");
